...
var drawMap = function(maxx, maxy, startx, starty, timed = false, label = "", useTime = false) {
  ...
  for (var i = starty; i < (maxy + starty); i++) {
    ...
    for (var k = startx; k < (maxx + startx); k++) {
      ...
      var randx = planets[currentPlanet]["biomes"][biomeid][0];
      var randy = planets[currentPlanet]["biomes"][biomeid][1];
      var biome = planets[currentPlanet]["biomes"][biomeid][2];
      ...
      if (useTime === true) {
        if (tiles[currentPlanet][playerpos].posx !== tile.posx || tiles[currentPlanet][playerpos].posy !== tile.posy) {
          if (firstDraw === false) {
...
var drawInventory = function() {
  ...
  menuInventory.innerHTML = '<h2 class="title">' + i18nGet("menu.inventory") + '</h2>';
...
var saveWindow = function() {
  ...
  if (presence !== "save") {
    ...
    menu.id = 'menu_save';
    menu.className = 'menu';
    menu.innerHTML = '<h2 class="title">' + i18nGet("menu.save") + '</h2>';
      ...
      if (savename !== null) {
        ...
        if (saved === false) {
          ...
          if (saveconfirm === true) {
            ...
            var content = "<span style='color: #009900;'>&nbsp;&nbsp;&nbsp;&nbsp;<i class='fa fa-save fa-3x fa-fw' aria-hidden='true' style='display: inline;'></i>&nbsp;&nbsp;&nbsp;&nbsp;<h3 style='font-family: Ubuntu; display: inline;'>Game Saved Successfully!</h3></span>";
            notice(content);
          }
        } else {
          var content = "<span style='color: #009900;'>&nbsp;&nbsp;&nbsp;&nbsp;<i class='fa fa-save fa-3x fa-fw' aria-hidden='true' style='display: inline;'></i>&nbsp;&nbsp;&nbsp;&nbsp;<h3 style='font-family: Ubuntu; display: inline;'>Game Saved Successfully!</h3></span>";
    ...
    for (var i = 0; i < saves.length; i++) {
      ...
      loadbutton.onclick = function(buttonid = this.id) {
        ...
        var content = "<span style='color: #009900;'>&nbsp;&nbsp;&nbsp;&nbsp;<i class='fa fa-save fa-3x fa-fw' aria-hidden='true' style='display: inline;'></i>&nbsp;&nbsp;&nbsp;&nbsp;<h3 style='font-family: Ubuntu; display: inline;'>Game Loaded Successfully!</h3></span>";
        notice(content);
        saveWindow();
      }
...
var loadFromBrowser = function(save_slot = 0) {
  if (typeof(Storage) !== "undefined") {

class Mod {
  constructor(modName, modDesc, modItems, modOres, modRecipes, modStations, modPlaceable, modPlaceFeatures, modCategories, modRegularCategories, modPlanets, modI18n) {
    this.name = modName;
    this.desc = modDesc;
    this.items = modItems;
    this.ores = modOres;

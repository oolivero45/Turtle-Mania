...
function giveAchievement(name) {
  ...
  var content = "<span id='achievementImage' style='background-position: -" + icon[0] + "px -" + icon[1] + "px;'></span><b>Achievement Get: " + title + "</b><br><p style='display: inline;'>" + description + "</p><br><b style='display: inline;'>Skin item unlocked: </b><p style='display: inline;'>Head: " + i18nGet("skin." + reward[0]) + ", Body: " + i18nGet("skin." + reward[1]) + ", Legs: " + i18nGet("skin." + reward[2]) + ", Accessory: " + i18nGet("skin." + reward[3]) + "</p>";
  notice(content);

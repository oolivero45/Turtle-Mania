var modItems = {
  ...
  "item.tank.fluid" : [5, 20],
  "item.tank.fluid.water" : [6, 19],
  "item.tank.fluid.fuel" : [7, 19],
  "item.tank.fluid.thermogel" : [8, 19],
  "item.tank.fluid.coolant" : [9, 19],
  ...
  "item.ice_floor_a" : [3,16],
  "item.ice_floor_b" : [4,16],
  "item.ice" : [12,5],
  "item.compressed_ice" : [13,5],
  "item.fancy_wood_floor" : [5,16],
};
...
var modRecipes = {
  ...
  // Floors
  "item.concrete": [4, [["item.stone",4]], "category.floors"],
  "item.brick_floor": [4, [["item.brick",4]], "category.floors"],
  "item.wood_floor": [1, [["item.plank",4]], "category.floors"],
  "item.ice_floor_a": [1, [["item.ice",2]], "category.floors"],
  "item.ice_floor_b": [1, [["item.ice_floor_a",4]], "category.floors"],
  "item.fancy_wood_floor": [1, [["item.wood_floor",1],["item.plank",1]], "category.floors"],
  ...
  "item.compressed_ice" : [1, [["item.ice",8]], "category.other"],
};
...
var modPlaceable = {
  ...
  "item.ice_floor_a" : "ice_floor_a",
  "item.ice_floor_b" : "ice_floor_b",
  "item.fancy_wood_floor" : "fancy_wood_floor",
...
var modPlaceFeatures = {
  "concrete" : [true, "concrete", 0, 512, [null], "item.concrete", 1, "stone"],
  "brick" : [true, "brick", 32, 512, [null], "item.brick_floor", 1, "stone"],
  "planks" : [true, "planks", 64, 512, [null], "item.wood_floor", 1, "wood"],
  "ice_floor_a" : [true, "ice_floor_a", 96, 512, [null], "item.ice_floor_a", 1, "ice"],
  "ice_floor_b" : [true, "ice_floor_b", 128, 512, [null], "item.ice_floor_b", 1, "ice"],
  "fancy_wood_floor" : [true, "fancy_wood_floor", 160, 512, [null], "item.fancy_wood_floor", 1, "wood"],
  "rocket" : [true, "rocket", 128, 160, [null], "item.rocket", 1, "none"],
  "station_furnace" : [true, "station_furnace", 0, 576, [null], "item.station.furnace", 1, "stone"],
  "station_press" : [true, "station_press", 32, 576, [null], "item.station.press", 1, "none"],
  "station_rollingmachine" : [true, "station_rollingmachine", 64, 576, [null], "item.station.rollingmachine", 1, "none"],
  "station_electrolyser" : [true, "station_electrolyser", 96, 576, [null], "item.station.electrolyser", 1, "none"],
  "station_reactionchamber" : [true, "station_reactionchamber", 128, 576, [null], "item.station.reactionchamber", 1, "none"],
  "station_airfilter" : [true, "station_airfilter", 160, 576, [null], "item.station.airfilter", 1, "none"],
  "station_rocketstation" : [true, "station_rocketstation", 192, 576, [null], "item.station.rocketstation", 1, "none"],
}
...
var modPlanets = {
  "earth" : {
    ...
    "biomes" : {
      ...
      1 : [[[0, 0]], "ocean"],
      2 : [[[1, 0]], "snow"],
      3 : [[[18, 21], [19, 21], [20, 21], [21, 21], [22, 21], [23, 21], [23, 21], [23, 21], [23, 21]], "tundra"],
      4 : [[[0, 21], [1, 21], [2, 21], [3, 21], [4, 21], [5, 21], [5, 21], [5, 21], [5, 21]], "plains"],
      5 : [[[6, 21], [7, 21], [8, 21], [9, 21], [10, 21], [11, 21], [11, 21], [11, 21], [11, 21]], "swamp"],
      6 : [[[12, 21], [13, 21], [14, 21], [15, 21], [16, 21], [17, 21], [17, 21], [17, 21], [17, 21]], "savannah"],
      7 : [[[6, 0]], "desert"],
      8 : [[[7, 0]], "volcano"],
      9 : [[[0, 0]], "ocean"],
      10 : [[[0, 0]], "ocean"],
    ...
    "features" : {
      0 : [true, "flowers-1", 0, 96, ["tundra","plains","swamp"], "item.stick", 1, "none"],
      1 : [true, "flowers-2", 32, 96, ["tundra","plains","swamp"], "item.stick", 1, "none"],
      2 : [true, "flowers-3", 64, 96, ["tundra","plains","swamp"], "item.stick", 1, "none"],
      3 : [true, "rock", 160, 96, ["snow","tundra","plains","swamp","savannah","desert"], "ore", 10, "stone"],
      4 : [true, "savannah_tree", 224, 96, ["savannah"], "item.wood", 10, "wood"],
      5 : [true, "swamp_tree", 288, 96, ["swamp"], "item.wood", 10, "wood"],
      6 : [true, "plains_tree", 128, 96, ["plains"], "item.wood", 10, "wood"],
      7 : [true, "tundra_tree", 192, 96, ["tundra"], "item.wood", 10, "wood"],
      8 : [true, "snow_tree", 416, 96, ["snow","tundra"], "item.wood", 10, "wood"],
      9 : [true, "swamp_tree_2", 384, 96, ["swamp"], "item.wood", 10, "wood"],
      10 : [true, "cactus", 320, 96, ["desert"], "item.wood", 10, "none"],
      11 : [true, "cacti", 352, 96, ["desert"], "item.wood", 3, "none"],
      12 : [true, "glacier", 448, 96, ["snow"], "item.ice", 5, "ice"],
      13 : [true, "volcano", 480, 96, ["volcano"], "ore", 10, "stone"],
      //14 : [true, "mossy_rock", 544, 96, ["swamp"], "ore", 10], // removed because it didn't look very good.
    },
    "atmosphere" : true,
    "temperature" : 293,
  },
  "moon" : {
    ...
    "features" : {
      0 : [true, "rock", 160, 96, ["dark"], "ore", 10, "none"],
    },
    "atmosphere" : false,
    "temperature" : 100,
  },
  "mars" : {
    ...
    "features" : {
      0 : [true, "mars_rock", 512, 96, ["bright"], "ore", 10, "none"],
    },
    "atmosphere" : false,
    "temperature" : 200,
  },
...
var modI18n = {
  "en-GB": {
    ...
    "item.bar.frozen_steel" : "Frozen Steel Ingot",
    ...
    "item.plate.frozen_steel" : "Frozen Steel Plate",
    ...
    "item.rod.frozen_steel" : "Frozen Steel Rod",
    ...
    // Debug Multitool
    "item.tool.debug" : "Debug Multitool",
    ...
    "item.tank.fluid.thermogel" : "ThermoGel Tank",
    "item.tank.fluid.coolant" : "Coolant Tank",
    ...
    "item.ice_floor_a" : "Rough Ice Floor",
    "item.ice_floor_b" : "Smooth Ice Floor",
    "item.fancy_wood_floor" : "Fancy Wood Floor",
    "item.ice" : "Ice",
    "item.compressed_ice" : "Compressed Ice",
    ...
    "desc.item.bar.frozen_steel" : "An ingot made of solid Frozen Steel",
    ...
    "desc.item.plate.frozen_steel" : "A plate formed from Frozen Steel",
    ...
    "desc.item.rod.frozen_steel" : "A rod of Frozen Steel",
    ...
    // Debug Multitool
    "desc.item.tool.debug" : "Now that's a lot of damage!",
    ...
    "desc.item.tank.fluid.thermogel" : "A tank of ThermoGel.\nProvides heat in hostile environments.",
    "desc.item.tank.fluid.coolant" : "A tank of coolant.\nCounteracts heat in hostile environments.",
    ...
    "skin.debug-white" : "Debug White",
    "skin.debug-red" : "Debug Red",
    "skin.debug-orange" : "Debug Orange",
    "skin.debug-yellow" : "Debug Yellow",
    "skin.debug-green" : "Debug Green",
    "skin.debug-aqua" : "Debug Aqua",
    "skin.debug-blue" : "Debug Blue",
    "skin.debug-pink" : "Debug Pink",
...
<button class="large_button" onclick="javascript:saveWindow();">Save/Load</button>
<br>
<button class="large_button" onclick="javascript:skinWindow();">Change Skin</button>
<br>
<b class="title">Controls</b><br>
<b>W</b> - Move Up<br>
<b>A</b> - Move Left<br>
<b>S</b> - Move Right<br>
<b>D</b> - Move Down<br>
<b>Q</b> - Delete Item<br>
<b>C</b> - Open Crafting Menu<br>
<b>H</b> - Open Help Menu<br>
<b>I</b> or <b>E</b> - Open Inventory<br>
<b>P</b> - Open Skin Customisation Menu<br>
<b>Number Keys</b> - Select Toolbar Slot<br><br>


<b class="title">Goal</b><br>
<p>Your goal is to harvest, collect and craft the components required to build a rocket.</p><br><br>


<b class="title">Selectors</b><br>
<span class="selector_preview selector_white"></span> Regular tile<br>
<span class="selector_preview selector_red"></span> Obstructed Tile<br>
<span class="selector_preview selector_yellow"></span> Harvestable Tile<br><br>


<b class="title">How to Harvest Resources</b><br>
<p>Move next to the tile you want to harvest, and left click on it.<br>
If you are mining a rock, the ores that you get will depend on what biome you are currently in:</p>
<ul>
<li>Snow: Stone, Coal, Osmium, Cobalt and Diamond</li>
<li>Tundra: Stone, Coal, Tin, Silver and Sapphire</li>
<li>Plains: Stone, Coal, Copper, Uranium and Jade</li>
<li>Swamp: Stone, Coal, Lead, Iron and Emerald</li>
<li>Savannah: Stone, Coal, Nickel, Gold and Topaz</li>
<li>Desert: Stone, Coal, Titanium and Ruby</li>
</ul><br><br>


<b class="title">How to Use your Inventory</b><br>
<p>To put an item into your inventory, select the slot on your toolbar that contains the item, and click on the slot in your inventory that you want to put the item into.<br>
To take an item out of your inventory, select the slot on your toolbar that you want to put the item into, and click on the slot in your inventory that contains the item.</p><br><br>


<b class="title">Language</b><br>
<p>Your language is currently set as !!!LANGUAGE_REPLACE!!!</p><br><br>


<b class="title">Credits</b><br>
<p>
Main game code by Oliver Cox<br>
Artwork by SOOP.<br>
<br>
<br>
I would like to thank the following people for providing resources that have been used in this project:<br></p>
<ul>
<li>The team behind jQuery, for providing such an amazing library. Without you, the internet literally wouldn't be the way it is today.</li>
<li>The person behind webtoolkit.info, for providing a funciton to encode and decode base64 strings in JavaScript. Thank you for making your code publicly available - it has proven to be extremely helpful! The script was found here: <a href="http://www.webtoolkit.info/javascript-base64.html">http://www.webtoolkit.info/javascript-base64.html</a></li>
<li>Pieroxy, the author of lz-string, a script which has managed to make our 350kb+ save files become less than 50kb. Thank you for your code, and in particular, thank you for releasing it under such a permissive license. The script can be found here: <a href="https://github.com/pieroxy/lz-string">https://github.com/pieroxy/lz-string</a></li>
<li>Joseph G, the person behind the perlin noise script I am using for biome generation. Seriously, your code was a lifesaver. I spent over ten hours trying to find a way to make biome generation work smoothly, but your code managed to help me do this in under half an hour. Thank you. <3. The script can be found here: <a href="https://github.com/josephg/noisejs">https://github.com/josephg/noisejs</a></li>
<li>Bryce Neal, the author of easystar.js, the script that I am using for pathfinding. Thank you for your code, it has helped massively. <a href="https://github.com/prettymuchbryce/easystarjs">https://github.com/prettymuchbryce/easystarjs</a></li>
</ul>
<br><br>
...
`,
  ...
  "en-US": {
    ...
    "item.bar.frozen_steel" : "Frozen Steel Bar",
    ...
    "desc.item.bar.frozen_steel" : "A bar made of solid Frozen Steel",
    ...
    "desc.item.fancy_wood_floor" : "A fancy wooden floor.\nYou get a movement speed multiplier of 2x on this.",
    "desc.item.ice" : "A lump of cold, slippery ice.",
    "desc.item.compressed_ice" : "A block of compressed ice.",
...
var coreMod = new Mod("core", "Core game content. The game will not function correctly if this mod is not loaded.", modItems, modOres, modRecipes, modCraftingStations, modPlaceable, modPlaceFeatures, modCategories, modRegularCategories, modPlanets, modI18n, modFloors, modSounds);
coreMod.register();